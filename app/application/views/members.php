...
<div class="container offset-top">
	...
	<div class="well col-lg-10">
		...
		<input type="text" id="first_name" class="col-lg-12">
		<br><br><br><br>

		<label for="middle_name">Middle Name:</label> 
		<input type="text" id="middle_name" class="col-lg-12">
		<br><br><br><br>

		<label for="surname">Surname:</label> 
		<input type="text" id="surname" class="col-lg-12">
		<br><br><br><br>
		<hr class="hrDividerBetween">
		...
		<form method="POST">
			...
			<input type="text" id="old_password/" class="col-lg-12">
			<br><br><br><br>

			<label for="new_password">New password</label> 
			<input type="text" id="new_password" class="col-lg-12">
			<br><br><br><br>

			<label for="conf_new_password">Confirm New password</label> 
			<input type="text" id="conf_new_password" class="col-lg-12">
			<br><br><br><br>
